...
def get_dqn_args_train():
    ...
    parser.add_argument("--eps_end", default=0.02, type=float)  # Epsilon greedy end value
    parser.add_argument("--eps_decay", default=0.95, type=float)  # Epsilon greedy decay
